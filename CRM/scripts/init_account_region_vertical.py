...
def run():
    ...
    cur.execute("alter table accounts add column if not exists region varchar(100)")
    cur.execute("alter table accounts add column if not exists vertical varchar(100)")
